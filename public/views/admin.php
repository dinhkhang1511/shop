            ...
            <tbody>
              ...
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td class="d-none d-md-table-cell"><?= $product['author_name'] ?></td>
                  <td >
                    <span class="badge badge-success"><?= $product['quantity'] ?></span>
                  </td>
                  <td >
                    <img style="width: 100px; height: 100px;" src=" <?=Config::SITE_URL . 'public/img/product_img/' . $product['image'] . Config::EXT_IMG ?> "> </img>
                  </td>
                  <?php if($product['author'] == $user['id'] || $user['role'] == 'admin' && $product['author_role'] == 'user'): ?>
                    <td class="text-right">
                      <div class="dropdown show d-inline-block widget-dropdown">
                        <a class="dropdown-toggle icon-burger-mini" href="" role="button" id="dropdown-recent-order1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static"></a>
                        <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                          <li class="dropdown-item">
                          <form action="<?= Config::SITE_URL ?>public/product" method="POST">
                              <input type="hidden" name="product_id" value="<?php echo $product['id']?>">
                              <button type='submit'>Edit</button>
                            </form>
                          </li>
                          <li class="dropdown-item">
                            <form action="<?= Config::SITE_URL ?>public/delProduct" method="POST">
                              <input type="hidden" name="product_id" value="<?php echo $product['id']?>">
